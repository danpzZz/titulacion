  ...
  if (a(e)) {
    ...
    if (G(a2, k)) {
      let n = a2.replaceAll(k, (l2) => {
        let c2 = l2.replace(/{|}/g, "").split(".").filter((m2) => !s3.some((d2) => G(m2, d2)));
        return `var(${ae2(r, re(c2.join("-")))}${s(i2) ? `, ${i2}` : ""})`;
      });
...
function le(e, t) {
  ...
  function r(n, l2) {
    ...
    for (; c2 <= n.length; ) {
      let g3 = n[c2];
      if ((g3 === '"' || g3 === "'" || g3 === "`") && n[c2 - 1] !== "\\" && (d2 = d2 === g3 ? null : g3), !d2 && (g3 === "(" && u++, g3 === ")" && u--, (g3 === "," || c2 === n.length) && u === 0)) {
        let f = m2.trim();
...
var D = (e, t, r) => {
  e = Te(e), t = Te(t);
  let a2 = (r / 100 * 2 - 1 + 1) / 2, n = 1 - a2, l2 = Ne(e), o = Ne(t), c2 = Math.round(l2.r * a2 + o.r * n), m2 = Math.round(l2.g * a2 + o.g * n), d2 = Math.round(l2.b * a2 + o.b * n);
  return gt(c2, m2, d2);
};
...
var w3 = (e = {}) => {
  ...
  return { preset(s3) {
    ...
    var o, c2;
    let { semantic: i2 } = t || {}, a2 = s3 && Object.hasOwn(s3, "light") ? s3.light : s3, n = s3 && Object.hasOwn(s3, "dark") ? s3.dark : s3, l2 = { colorScheme: { light: h(h({}, (o = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : o.light), !!a2 && { surface: a2 }), dark: h(h({}, (c2 = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : c2.dark), !!n && { surface: n }) } };
...
var b = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(a2) && n.transform !== "strict") {
    ...
    d2 = `${et}${tt}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], g3 = m(a2.css, { dt: E });
  }
  return { primitive: { css: l2, tokens: o }, semantic: { css: c2, tokens: m2 }, global: { css: d2, tokens: u }, style: g3 };
}, getPreset({ name: e = "", preset: t = {}, options: r, params: s3, set: i2, defaults: a2, selector: n }) {
  var f, x2, p;
  let l2, o, c2;
  if (s(t) && r.transform !== "strict") {
    let y = e.replace("-directive", ""), m2 = t, { colorScheme: R2, extend: T, css: j } = m2, O = v(m2, ["colorScheme", "extend", "css"]), d2 = T || {}, { colorScheme: M } = d2, z2 = v(d2, ["colorScheme"]), u = R2 || {}, { dark: V } = u, L = v(u, ["dark"]), g3 = M || {}, { dark: te2 } = g3, re2 = v(g3, ["dark"]), K2 = s(O) ? this._toVariables({ [y]: h(h({}, O), z2) }, r) : {}, A = s(L) ? this._toVariables({ [y]: h(h({}, L), re2) }, r) : {}, X = s(V) ? this._toVariables({ [y]: h(h({}, V), te2) }, r) : {}, [G2, U] = [(f = K2.declarations) != null ? f : "", K2.tokens || []], [B, I] = [(x2 = A.declarations) != null ? x2 : "", A.tokens || []], [H2, W2] = [(p = X.declarations) != null ? p : "", X.tokens || []], q2 = this.transformCSS(y, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y, H2, "dark", "variable", r, i2, a2, n);
    l2 = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U, ...I, ...W2])], c2 = m(j, { dt: E });
  }
  ...
  return Object.entries(n || {}).reduce((o, [c2, m2]) => {
    if (i(m2) && Object.hasOwn(m2, "css")) {
      let d2 = Y(m2.css), u = `${c2}-variables`;
  ...
  let a2 = function(l2, o = {}, c2 = []) {
    ...
    Object.entries(l2).forEach(([m2, d2]) => {
      let u = G(m2, t.variable.excludedKeyRegex) ? o : o ? `${o}.${oe2(m2)}` : oe2(m2), g3 = c2 ? `${c2}.${m2}` : m2;
  ...
  if (s(t)) {
    ...
    if (s3 !== "style") {
      ...
      t = r === "dark" ? c2.reduce((m2, { type: d2, selector: u }) => (s(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l2, d2, t)), m2), "") : C2(l2 != null ? l2 : ":root,:host", t);
    }
    if (o) {
      let c2 = { name: "primeui", order: "primeui" };
      i(o) && (c2.name = m(o.name, { name: e, type: s3 })), s(c2.name) && (t = C2(`@layer ${c2.name}`, t), a2 == null || a2.layerNames(c2.name));
    }
    return t;
  }
  return "";
...
//# sourceMappingURL=chunk-Z4TEE3MD.js.map
